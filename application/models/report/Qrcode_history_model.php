	...
	public function get_detail_html($data,$type){
		$html = "<div>
					...
					<table class='table table-sm table-reponsive'>
                        ...
                        if(!empty($data) && ($data[0]['brmm_delete_status'] == 0 && $data[0]['bal_qty'] > 0)):
                           $enc_id =  encrypt_decrypt("encrypt", $data[0]['brmm_id'], SECRET_KEY); 
                          $url= base_url('transaction/purchase_readymade?action=barcode&clause=brmm.brmm_id&id='.$enc_id);
                            ...
                            <tr>
                                ...
                                <td>
                                   <button 
                                    ...
                                    ><i class='text-info fa fa-save'></i></button>     
                                </td>
                                <td>
                                    <a 
                                        type='button' 
