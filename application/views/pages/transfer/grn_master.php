...
<section class="container-fluid sticky_top">
	<form class="form-horizontal" id="search_form" action="<?php echo base_url('transfer/grn?action=view')?>" method="get">
			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item" aria-current="reload-page">
			    	<a type="button" class="btn btn-sm btn-primary" onclick="redirectPage('transfer/grn?action=view')" data-toggle="tooltip" data-placement="bottom" title="REFRESH"><i class="text-info fa fa-undo"></i></a>
			    </li>
				...
				<tbody id="table_tbody">
					...
					?>
								...
								<tr>
									...
									<td width="3%">
										<a type="button" class="btn btn-sm btn-primary" onclick="redirectPage('<?php echo 'transfer/grn?action=edit&id='.$value['gm_id'] ?>')">
									...
									<td width="4%">
										...
										<?php else: ?>
											<a type="button" class="btn btn-sm btn-primary" onclick="remove_master('<?php echo 'transfer/grn/remove/'.$value['gm_id']?>');">
