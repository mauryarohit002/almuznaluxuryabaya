                                ...
                                ?>
                                        <tr id="rowid_<?php echo $outward_cnt; ?>" class="floating-form <?php echo !empty($master_data) && $value['_status'] == 1 ? 'show_pending' : '' ; ?>">
                                            <td>
                                                ...
                                                <input type="hidden" name="gt_brmm_id[]" id="gt_brmm_id_<?php echo $outward_cnt ?>" value="<?php echo $value['_brmm_id']; ?>" />
                                            ...
                                            <!-- <td> -->
                                                <input type="hidden" class="form-control floating-input" name="gt_bill_no[]" id="gt_bill_no_<?php echo $outward_cnt ?>" value="<?php echo $value['_bill_no'] ?>" readonly />
                                                <input type="hidden" name="gt_prmm_id[]" id="gt_prmm_id_<?php echo $outward_cnt ?>" value="<?php echo $value['_prmm_id'] ?>" />
                                            <!-- </td> -->

                                            <!-- <td> -->
                                                <input type="hidden" class="form-control floating-input" name="gt_bill_date[]" id="gt_bill_date_<?php echo $outward_cnt ?>" value="<?php echo date('d-m-Y', strtotime($value['_bill_date'])) ?>" readonly />
                                            <!-- </td> -->
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="gt_sku_id[]" id="gt_sku_id_<?php echo $outward_cnt ?>" value="<?php echo $value['_sku_id'] ?>" />
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="gt_apparel_id[]" id="gt_apparel_id_<?php echo $outward_cnt ?>" value="<?php echo $value['_apparel_id'] ?>" />
                                            </td>
