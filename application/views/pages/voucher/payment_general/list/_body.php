    ...
    <?php 
        if(!empty($data)): 
            foreach ($data as $key => $value):
                $id = encrypt_decrypt("encrypt", $value['payment_general_id'], SECRET_KEY);
    ?>
                <tr>
                    <td width="3%"><?php echo $key+1; ?></td>
                    <td width="7%"><?php echo $value['payment_general_entry_no']; ?></td>
                    <td width="10%"><?php echo $value['entry_date']; ?></td>
                    <td width="15%"><?php echo $value['general_name']; ?></td>
                    <td width="10%"><?php echo $value['payment_general_amt']; ?></td>
                    <td width="15%"><?php echo $value['payment_general_notes']; ?></td>
