    ...
    <?php 
        if(!empty($data)): 
            foreach ($data as $key => $value):
                $id = encrypt_decrypt("encrypt", $value['karigar_payment_id'], SECRET_KEY);
    ?>
                <tr>
                    <td width="3%"><?php echo $key+1; ?></td> 
                    <td width="7%"><?php echo $value['karigar_payment_entry_no']; ?></td>
                    <td width="10%"><?php echo $value['entry_date']; ?></td>
                    <td width="15%"><?php echo $value['karigar_name']; ?></td>
                    <td width="10%"><?php echo $value['karigar_payment_amt']; ?></td>
                    <td width="15%"><?php echo $value['karigar_payment_notes']; ?></td>
                    <td width="10%"><?php echo $value['karigar_payment_adjust_status'] == 1 ? 'ADJUSTED' : 'PENDING'; ?></td>
