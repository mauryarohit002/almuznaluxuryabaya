<div class="d-flex justify-content-between">
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-4 d-flex flex-wrap floating-form">
        <?php if(in_array('reschedule', $action_data)): ?>
            <div class="col-12 col-sm-12 col-md-4 col-lg-6 floating-label mt-3">
                <input 
                    type="date" 
                    class="form-control floating-input reschedule_trial_date_checkboxes" 
                    id="reschedule_trial_date" 
                    value="" 
                    placeholder=" " 
                    autocomplete="off" 
                />   
                <label class="text-uppercase">reschedule trial date</label>
            </div>
            <div class="col-12 col-sm-12 col-md-4 col-lg-2">
                <button
                    type="button"
                    class="btn btn-md btn-secondary text-uppercase mt-3"
                    onclick="add_reschedule_trial_date()"
                >add new trial date (<span id="reschedule_trial_date_count">0</span>)</button>
            </div>
        <?php endif; ?>
    </div>
    <div class="d-flex align-items-center">
        <a 
            ...
            title="DELIVERY"
            href="<?php echo base_url($menu.'/delivery_schedule'); ?>"
