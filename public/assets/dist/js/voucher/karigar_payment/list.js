...
const remove_record = (data) => {
  ...
  const form_data = { func: "remove", id: data.karigar_payment_id };
  let html = `<table class="table table-sm table-hover" style="font-size:0.8rem;">
                  <tbody>
                      <tr>
                          ...
                          <td width="70%">${data.karigar_payment_entry_no}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          ...
                          <td class="font-weight-bold text-uppercase" width="70%">${data.karigar_payment_amt}</td>
                      </tr>
                  </tbody>
              </table>`;
